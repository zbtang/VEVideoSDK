#
# Be sure to run `pod lib lint VEVideoSDK.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'VEVideoSDK'
  s.version          = '0.1.0'
  s.summary          = 'A short description of VEVideoSDK.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'VEVideoSDK/Classes/**/*'
  
  # s.resource_bundles = {
  #   'VEVideoSDK' => ['VEVideoSDK/Assets/*.png']
  # }
